...
#---------------------------
cat("Loading data...\n")
tr <- read_csv("/home/bijan/.kaggle/competitions/home-credit-default-risk/application_train.csv")
te <- read_csv("/home/bijan/.kaggle/competitions/home-credit-default-risk/application_test.csv")

bureau <- read_csv("/home/bijan/.kaggle/competitions/home-credit-default-risk/bureau.csv") %>%
  mutate_if(is.character, funs(factor(.) %>% as.integer()))

cred_card_bal <-  read_csv("/home/bijan/.kaggle/competitions/home-credit-default-risk/credit_card_balance.csv") %>%
  mutate_if(is.character, funs(factor(.) %>% as.integer()))

pos_cash_bal <- read_csv("/home/bijan/.kaggle/competitions/home-credit-default-risk/POS_CASH_balance.csv") %>%
  mutate_if(is.character, funs(factor(.) %>% as.integer()))

prev <- read_csv("/home/bijan/.kaggle/competitions/home-credit-default-risk/previous_application.csv") %>%
  mutate_if(is.character, funs(factor(.) %>% as.integer()))
...
#---------------------------
read_csv("/home/bijan/.kaggle/competitions/home-credit-default-risk/sample_submission.csv") %>%
